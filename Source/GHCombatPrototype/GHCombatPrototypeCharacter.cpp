...
#include "GHCombatPrototypeCharacter.h"
...
void AGHCombatPrototypeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGHCombatPrototypeCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AGHCombatPrototypeCharacter::Look);
...
void AGHCombatPrototypeCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGHCombatPrototypeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGHCombatPrototypeCharacter::DoMove(float Right, float Forward)
{
...
void AGHCombatPrototypeCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AGHCombatPrototypeCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AGHCombatPrototypeCharacter::DoJumpEnd()
{
